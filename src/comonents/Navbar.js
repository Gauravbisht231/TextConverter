        ...
        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li className="nav-item dropdown">
            ...
            <ul className="dropdown-menu">
              <li><a className="dropdown-item" href="#">{props.company}</a></li>
...
Navbar.propTypes= {title:PropTypes.string, company: PropTypes.string}
Navbar.defaultProps={title:'set.title.here', company: 'About.company'};
